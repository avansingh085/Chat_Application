        ...
        <div className="w-16 h-screen border-x-2 bg-gray-100 flex flex-col justify-between py-4">
            ...
            <div className="grid gap-6 w-16 items-center justify-center">
                ...
                <a href="#home" title="Home">
                    <svg className="h-8 w-8 text-gray-700 hover:text-blue-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="grid gap-6 w-16 items-center justify-center">
                ...
                <a href="#logout" title="Logout">
                    <svg className="h-8 w-8 text-gray-700 hover:text-red-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
